...
class ItemList extends Component {
    ...
    async handleChangeSearch(event) {
        ...
        try {
            const data = {
                title: this.state.querySearch
            }
            this.setState({querySearch: data.result});
    ...
    render() {
        return (
            <div className={classes.itemList}>
                ...
                <SearchBar value={this.state.querySearch} onChange={this.handleChangeSearch}></SearchBar>
                <br />
                ...
                <Modal
                    show={this.state.isCreate || this.state.isEdit} handleCloseModal={this.handleCancel}
                ...
                >
                    ...
                    /> <input className={classes.textField}
                              type="text" placeholder="Kategori" name="category" value={this.state.category}
                              onChange={this.handleChangeField}
